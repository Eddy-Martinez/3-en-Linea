...
def checker(buttons):
        ...
        if buttons["text"] == " " and click == True:
              ...
              button3["text"] == "X" and button6["text"] == "X" and button9["text"] == "X"):
                tkinter.messagebox.showinfo("Has Ganado","Gana la X")
              ...
              button3["text"] == "O" and button6["text"] == "O" and button9["text"] == "O"):
                tkinter.messagebox.showinfo("Has Ganado","Gana el O")        
             ...
             button7["text"] == "O" and button8["text"] == "O" and button9["text"] == "X"):
                tkinter.messagebox.showinfo("Nadie ha Ganado", "Empate")


       

buttons=StringVar()
button1 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Blue",command = lambda:checker(button1))

button1.grid(row=1, column=0, sticky = S+N+E+W)

button2 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Red", command = lambda:checker(button2))

button2.grid(row=1, column=1, sticky = S+N+E+W)

button3 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Blue", command = lambda:checker(button3))

button3.grid(row=1, column=2, sticky = S+N+E+W)

button4 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Red", command = lambda:checker(button4))

button4.grid(row=2, column=0, sticky = S+N+E+W)

button5 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Blue",command = lambda:checker(button5))

button5.grid(row=2, column=1, sticky = S+N+E+W)

button6 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Red", command = lambda:checker(button6))

button6.grid(row=2, column=2, sticky = S+N+E+W)

button7 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Blue", command = lambda:checker(button7))

button7.grid(row=3, column=0, sticky = S+N+E+W)

button8 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Red", command = lambda:checker(button8))

button8.grid(row=3, column=1, sticky = S+N+E+W)

button9 = Button(tk,text=" ", font=('Calibri 14'), height = 6, width = 8,bg="Blue", command = lambda:checker(button9))
